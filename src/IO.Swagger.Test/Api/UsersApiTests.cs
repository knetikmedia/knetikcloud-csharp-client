...
namespace IO.Swagger.Test
{
    ...
    public class UsersApiTests
    {
        ...
        public void GetUsersUsingGETTest()
        {
            ...
            //int? page = null;
            //string order = null;
            //var response = instance.GetUsersUsingGET(filterRole, filterDisplayname, filterEmail, filterFirstname, filterFullname, filterLastname, filterUsername, filterTag, filterGroup, size, page, order);
