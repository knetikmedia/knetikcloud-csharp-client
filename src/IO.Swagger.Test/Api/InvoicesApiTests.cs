...
namespace IO.Swagger.Test
{
    ...
    public class InvoicesApiTests
    {
        ...
        public void GetInvoicesTest()
        {
            ...
            //int? page = null;
            //string order = null;
            //var response = instance.GetInvoices(filterUser, filterEmail, filterFulfillmentStatus, filterPaymentStatus, filterItemName, filterExternalRef, filterCreatedDate, size, page, order);
