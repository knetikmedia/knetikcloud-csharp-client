...
namespace IO.Swagger.Test
{
    ...
    public class CampaignsChallengesApiTests
    {
        ...
        public void GetActivitiesUsingGET1Test()
        {
            ...
            //Assert.IsInstanceOf<PageBareChallengeActivityResource> (response, "response is PageBareChallengeActivityResource");
        }
        ...
        {
            // TODO uncomment below to test the method and replace null with proper value
            //long? filterStartDateMin = null;
            //long? filterStartDateMax = null;
            //long? filterEndDateMin = null;
            //long? filterEndDateMax = null;
            //bool? filterCampaigns = null;
            //long? filterChallenge = null;
            //int? size = null;
            //int? page = null;
            //string order = null;
            //var response = instance.GetChallengeEventssUsingGET(filterStartDateMin, filterStartDateMax, filterEndDateMin, filterEndDateMax, filterCampaigns, filterChallenge, size, page, order);
            //Assert.IsInstanceOf<PageChallengeEventResource> (response, "response is PageChallengeEventResource");
        }
        ...
        public void GetChallengesUsingGET1Test()
        {
            ...
            //Assert.IsInstanceOf<PageChallengeResource> (response, "response is PageChallengeResource");
        }
