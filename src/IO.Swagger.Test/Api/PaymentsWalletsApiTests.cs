...
namespace IO.Swagger.Test
{
    ...
    public class PaymentsWalletsApiTests
    {
        ...
        public void GetWalletTransactionsTest()
        {
            ...
            //int? page = null;
            //string order = null;
            //var response = instance.GetWalletTransactions(filterInvoice, filterType, filterMaxDate, filterMinDate, filterSign, filterUserId, filterUsername, filterDetails, filterCurrencyCode, size, page, order);
            //Assert.IsInstanceOf<PageResourceWalletTransactionResource> (response, "response is PageResourceWalletTransactionResource");
        }
