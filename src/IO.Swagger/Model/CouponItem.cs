...
namespace IO.Swagger.Model
{
    ...
    public partial class CouponItem :  IEquatable<CouponItem>, IValidatableObject
    {
        ...
        public CouponItem(Dictionary<string, Property> AdditionalProperties = null, List<Behavior> Behaviors = null, string Category = null, CouponTypeHintEnum? CouponTypeHint = null, double? DiscountMax = null, double? DiscountMinCartValue = null, DiscountTypeEnum? DiscountType = null, double? DiscountValue = null, bool? Displayable = null, bool? Exclusive = null, List<string> GeoCountryList = null, GeoPolicyTypeEnum? GeoPolicyType = null, int? ItemId = null, string LongDescription = null, int? MaxQuantity = null, string Name = null, bool? SelfExclusive = null, int? ShippingTier = null, string ShortDescription = null, List<Sku> Skus = null, int? Sort = null, long? StoreEnd = null, long? StoreStart = null, List<string> Tags = null, string Template = null, string TypeHint = null, string UniqueKey = null, List<string> ValidForTags = null, int? VendorId = null)
        {
