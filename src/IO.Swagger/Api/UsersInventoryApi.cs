...
namespace IO.Swagger.Api
{
    ...
    public interface IUsersInventoryApi : IApiAccessor
    {
        ...
        /// <param name="grantRequest">grantRequest</param>
        /// <returns>ApiResponse of Object(void)</returns>
        ApiResponse<Object> GrantEntitlementUsingPOSTWithHttpInfo (int? userId, EntitlementGrantRequest grantRequest);
        /// <summary>
        ...
        /// <param name="grantRequest">grantRequest</param>
        /// <returns>Task of void</returns>
        System.Threading.Tasks.Task GrantEntitlementUsingPOSTAsync (int? userId, EntitlementGrantRequest grantRequest);
        ...
        /// <param name="grantRequest">grantRequest</param>
        /// <returns>Task of ApiResponse</returns>
        System.Threading.Tasks.Task<ApiResponse<Object>> GrantEntitlementUsingPOSTAsyncWithHttpInfo (int? userId, EntitlementGrantRequest grantRequest);
        /// <summary>
        /// Update an entitlement item
        /// </summary>
        /// <remarks>
    ...
    public partial class UsersInventoryApi : IUsersInventoryApi
    {
        ...
        /// <param name="grantRequest">grantRequest</param>
        /// <returns></returns>
        public void GrantEntitlementUsingPOST (int? userId, EntitlementGrantRequest grantRequest)
        {
        ...
        /// <param name="grantRequest">grantRequest</param>
        /// <returns>ApiResponse of Object(void)</returns>
        public ApiResponse<Object> GrantEntitlementUsingPOSTWithHttpInfo (int? userId, EntitlementGrantRequest grantRequest)
        {
            // verify the required parameter 'userId' is set
            if (userId == null)
                throw new ApiException(400, "Missing required parameter 'userId' when calling UsersInventoryApi->GrantEntitlementUsingPOST");
            // verify the required parameter 'grantRequest' is set
            if (grantRequest == null)
                throw new ApiException(400, "Missing required parameter 'grantRequest' when calling UsersInventoryApi->GrantEntitlementUsingPOST");
            ...
            if (ExceptionFactory != null)
            {
                Exception exception = ExceptionFactory("GrantEntitlementUsingPOST", localVarResponse);
                if (exception != null) throw exception;
            }
        ...
        /// <param name="grantRequest">grantRequest</param>
        /// <returns>Task of void</returns>
        public async System.Threading.Tasks.Task GrantEntitlementUsingPOSTAsync (int? userId, EntitlementGrantRequest grantRequest)
        {
             await GrantEntitlementUsingPOSTAsyncWithHttpInfo(userId, grantRequest);
        ...
        /// <param name="grantRequest">grantRequest</param>
        /// <returns>Task of ApiResponse</returns>
        public async System.Threading.Tasks.Task<ApiResponse<Object>> GrantEntitlementUsingPOSTAsyncWithHttpInfo (int? userId, EntitlementGrantRequest grantRequest)
        {
            // verify the required parameter 'userId' is set
            if (userId == null)
                throw new ApiException(400, "Missing required parameter 'userId' when calling UsersInventoryApi->GrantEntitlementUsingPOST");
