...
namespace IO.Swagger.Api
{
    ...
    public interface IStoreShoppingCartsApi : IApiAccessor
    {
        ...
        ApiResponse<SampleCountriesResponse> GetCountriesWithHttpInfo (string id);
        /// <summary>
        ...
        System.Threading.Tasks.Task<SampleCountriesResponse> GetCountriesAsync (string id);
        ...
        System.Threading.Tasks.Task<ApiResponse<SampleCountriesResponse>> GetCountriesAsyncWithHttpInfo (string id);
        /// <summary>
        /// Returns whether a cart requires shipping
        /// </summary>
        /// <remarks>
    ...
    public partial class StoreShoppingCartsApi : IStoreShoppingCartsApi
    {
        ...
        /// <param name="id">The id of the cart</param>
        /// <returns>SampleCountriesResponse</returns>
        public SampleCountriesResponse GetCountries (string id)
        {
             ApiResponse<SampleCountriesResponse> localVarResponse = GetCountriesWithHttpInfo(id);
             return localVarResponse.Data;
        }
        ...
        /// <param name="id">The id of the cart</param>
        /// <returns>ApiResponse of SampleCountriesResponse</returns>
        public ApiResponse< SampleCountriesResponse > GetCountriesWithHttpInfo (string id)
        {
            // verify the required parameter 'id' is set
            if (id == null)
                throw new ApiException(400, "Missing required parameter 'id' when calling StoreShoppingCartsApi->GetCountries");
        ...
        /// <param name="id">The id of the cart</param>
        /// <returns>Task of SampleCountriesResponse</returns>
        public async System.Threading.Tasks.Task<SampleCountriesResponse> GetCountriesAsync (string id)
        {
             ApiResponse<SampleCountriesResponse> localVarResponse = await GetCountriesAsyncWithHttpInfo(id);
             return localVarResponse.Data;
        ...
        /// <param name="id">The id of the cart</param>
        /// <returns>Task of ApiResponse (SampleCountriesResponse)</returns>
        public async System.Threading.Tasks.Task<ApiResponse<SampleCountriesResponse>> GetCountriesAsyncWithHttpInfo (string id)
        {
            // verify the required parameter 'id' is set
            if (id == null)
                throw new ApiException(400, "Missing required parameter 'id' when calling StoreShoppingCartsApi->GetCountries");
