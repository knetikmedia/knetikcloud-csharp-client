...
namespace IO.Swagger.Api
{
    ...
    public interface ICategoriesApi : IApiAccessor
    {
        ...
        ApiResponse<Pagestring> GetTagsUsingGETWithHttpInfo (int? size = null, int? page = null, string order = null);
        /// <summary>
        ...
        System.Threading.Tasks.Task<Pagestring> GetTagsUsingGETAsync (int? size = null, int? page = null, string order = null);
        ...
        System.Threading.Tasks.Task<ApiResponse<Pagestring>> GetTagsUsingGETAsyncWithHttpInfo (int? size = null, int? page = null, string order = null);
        /// <summary>
        /// Get a single category template
        /// </summary>
        /// <remarks>
    ...
    public partial class CategoriesApi : ICategoriesApi
    {
        ...
        /// <param name="order">a comma separated list of sorting requirements in priority order, each entry matching PROPERTY_NAME:[ASC|DESC] (optional, default to 1)</param>
        /// <returns>Pagestring</returns>
        public Pagestring GetTagsUsingGET (int? size = null, int? page = null, string order = null)
        {
             ApiResponse<Pagestring> localVarResponse = GetTagsUsingGETWithHttpInfo(size, page, order);
             return localVarResponse.Data;
        }
        ...
        /// <param name="order">a comma separated list of sorting requirements in priority order, each entry matching PROPERTY_NAME:[ASC|DESC] (optional, default to 1)</param>
        /// <returns>ApiResponse of Pagestring</returns>
        public ApiResponse< Pagestring > GetTagsUsingGETWithHttpInfo (int? size = null, int? page = null, string order = null)
        {
        ...
        /// <param name="order">a comma separated list of sorting requirements in priority order, each entry matching PROPERTY_NAME:[ASC|DESC] (optional, default to 1)</param>
        /// <returns>Task of Pagestring</returns>
        public async System.Threading.Tasks.Task<Pagestring> GetTagsUsingGETAsync (int? size = null, int? page = null, string order = null)
        {
             ApiResponse<Pagestring> localVarResponse = await GetTagsUsingGETAsyncWithHttpInfo(size, page, order);
             return localVarResponse.Data;
        ...
        /// <param name="order">a comma separated list of sorting requirements in priority order, each entry matching PROPERTY_NAME:[ASC|DESC] (optional, default to 1)</param>
        /// <returns>Task of ApiResponse (Pagestring)</returns>
        public async System.Threading.Tasks.Task<ApiResponse<Pagestring>> GetTagsUsingGETAsyncWithHttpInfo (int? size = null, int? page = null, string order = null)
        {
