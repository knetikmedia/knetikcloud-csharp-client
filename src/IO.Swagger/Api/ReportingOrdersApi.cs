...
namespace IO.Swagger.Api
{
    ...
    public interface IReportingOrdersApi : IApiAccessor
    {
        ...
        ApiResponse<PageResourceAggregateInvoiceReportResource> GetDailyInvoicesUsingGETWithHttpInfo (string currencyCode, string granularity = null, string filterPaymentStatus = null, string filterFulfillmentStatus = null, long? startDate = null, long? endDate = null);
        ...
        System.Threading.Tasks.Task<PageResourceAggregateInvoiceReportResource> GetDailyInvoicesUsingGETAsync (string currencyCode, string granularity = null, string filterPaymentStatus = null, string filterFulfillmentStatus = null, long? startDate = null, long? endDate = null);
        ...
        System.Threading.Tasks.Task<ApiResponse<PageResourceAggregateInvoiceReportResource>> GetDailyInvoicesUsingGETAsyncWithHttpInfo (string currencyCode, string granularity = null, string filterPaymentStatus = null, string filterFulfillmentStatus = null, long? startDate = null, long? endDate = null);
    ...
    public partial class ReportingOrdersApi : IReportingOrdersApi
    {
        ...
        /// <param name="endDate">The end of the time range to return, unix timestamp in seconds. Default is end of time (optional)</param>
        /// <returns>PageResourceAggregateInvoiceReportResource</returns>
        public PageResourceAggregateInvoiceReportResource GetDailyInvoicesUsingGET (string currencyCode, string granularity = null, string filterPaymentStatus = null, string filterFulfillmentStatus = null, long? startDate = null, long? endDate = null)
        {
             ApiResponse<PageResourceAggregateInvoiceReportResource> localVarResponse = GetDailyInvoicesUsingGETWithHttpInfo(currencyCode, granularity, filterPaymentStatus, filterFulfillmentStatus, startDate, endDate);
        ...
        /// <param name="endDate">The end of the time range to return, unix timestamp in seconds. Default is end of time (optional)</param>
        /// <returns>ApiResponse of PageResourceAggregateInvoiceReportResource</returns>
        public ApiResponse< PageResourceAggregateInvoiceReportResource > GetDailyInvoicesUsingGETWithHttpInfo (string currencyCode, string granularity = null, string filterPaymentStatus = null, string filterFulfillmentStatus = null, long? startDate = null, long? endDate = null)
        {
        ...
        /// <param name="endDate">The end of the time range to return, unix timestamp in seconds. Default is end of time (optional)</param>
        /// <returns>Task of PageResourceAggregateInvoiceReportResource</returns>
        public async System.Threading.Tasks.Task<PageResourceAggregateInvoiceReportResource> GetDailyInvoicesUsingGETAsync (string currencyCode, string granularity = null, string filterPaymentStatus = null, string filterFulfillmentStatus = null, long? startDate = null, long? endDate = null)
        {
             ApiResponse<PageResourceAggregateInvoiceReportResource> localVarResponse = await GetDailyInvoicesUsingGETAsyncWithHttpInfo(currencyCode, granularity, filterPaymentStatus, filterFulfillmentStatus, startDate, endDate);
             return localVarResponse.Data;
        ...
        /// <param name="endDate">The end of the time range to return, unix timestamp in seconds. Default is end of time (optional)</param>
        /// <returns>Task of ApiResponse (PageResourceAggregateInvoiceReportResource)</returns>
        public async System.Threading.Tasks.Task<ApiResponse<PageResourceAggregateInvoiceReportResource>> GetDailyInvoicesUsingGETAsyncWithHttpInfo (string currencyCode, string granularity = null, string filterPaymentStatus = null, string filterFulfillmentStatus = null, long? startDate = null, long? endDate = null)
        {
            // verify the required parameter 'currencyCode' is set
            if (currencyCode == null)
                throw new ApiException(400, "Missing required parameter 'currencyCode' when calling ReportingOrdersApi->GetDailyInvoicesUsingGET");
