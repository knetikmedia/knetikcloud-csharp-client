...
namespace IO.Swagger.Api
{
    ...
    public interface IInvoicesApi : IApiAccessor
    {
        ...
        /// <param name="filterCreatedDate">Filters invoices by creation date. Multiple values possible for range search. Format: filter_date_created&#x3D;OP,ts&amp;... where OP in (GT, LT, GOE, LOE, EQ) and ts is a unix timestamp in seconds. Ex: filter_date_created&#x3D;GT,1452154258&amp;filter_date_created&#x3D;LT,1554254874 (optional)</param>
