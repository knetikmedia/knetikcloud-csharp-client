...
namespace IO.Swagger.Api
{
    ...
    public interface IAuthRolesApi : IApiAccessor
    {
        ...
        ApiResponse<PageResourceRoleResource> GetRolesUsingGETWithHttpInfo (int? size = null, int? page = null, string order = null);
        /// <summary>
        ...
        System.Threading.Tasks.Task<PageResourceRoleResource> GetRolesUsingGETAsync (int? size = null, int? page = null, string order = null);
        ...
        System.Threading.Tasks.Task<ApiResponse<PageResourceRoleResource>> GetRolesUsingGETAsyncWithHttpInfo (int? size = null, int? page = null, string order = null);
        /// <summary>
        /// Get roles for a user
        /// </summary>
        /// <remarks>
    ...
    public partial class AuthRolesApi : IAuthRolesApi
    {
        ...
        /// <param name="order">A comma separated list of sorting requirements in priority order, each entry matching PROPERTY_NAME:[ASC|DESC] (optional, default to name:ASC)</param>
        /// <returns>PageResourceRoleResource</returns>
        public PageResourceRoleResource GetRolesUsingGET (int? size = null, int? page = null, string order = null)
        {
             ApiResponse<PageResourceRoleResource> localVarResponse = GetRolesUsingGETWithHttpInfo(size, page, order);
             return localVarResponse.Data;
        }
        ...
        /// <param name="order">A comma separated list of sorting requirements in priority order, each entry matching PROPERTY_NAME:[ASC|DESC] (optional, default to name:ASC)</param>
        /// <returns>ApiResponse of PageResourceRoleResource</returns>
        public ApiResponse< PageResourceRoleResource > GetRolesUsingGETWithHttpInfo (int? size = null, int? page = null, string order = null)
        {
        ...
        /// <param name="order">A comma separated list of sorting requirements in priority order, each entry matching PROPERTY_NAME:[ASC|DESC] (optional, default to name:ASC)</param>
        /// <returns>Task of PageResourceRoleResource</returns>
        public async System.Threading.Tasks.Task<PageResourceRoleResource> GetRolesUsingGETAsync (int? size = null, int? page = null, string order = null)
        {
             ApiResponse<PageResourceRoleResource> localVarResponse = await GetRolesUsingGETAsyncWithHttpInfo(size, page, order);
             return localVarResponse.Data;
        ...
        /// <param name="order">A comma separated list of sorting requirements in priority order, each entry matching PROPERTY_NAME:[ASC|DESC] (optional, default to name:ASC)</param>
        /// <returns>Task of ApiResponse (PageResourceRoleResource)</returns>
        public async System.Threading.Tasks.Task<ApiResponse<PageResourceRoleResource>> GetRolesUsingGETAsyncWithHttpInfo (int? size = null, int? page = null, string order = null)
        {
