...
namespace IO.Swagger.Api
{
    ...
    public interface ICampaignsApi : IApiAccessor
    {
        ...
        ApiResponse<PageTemplateResource> GetCampaignTemplatesUsingGETWithHttpInfo (int? size = null, int? page = null, string order = null);
        /// <summary>
        ...
        /// <param name="page">The number of the page returned, starting with 1 (optional, default to 1)</param>
        /// <param name="order">A comma separated list of sorting requirements in priority order, each entry matching PROPERTY_NAME:[ASC|DESC] (optional, default to 1)</param>
        /// <returns>PageCampaignResource</returns>
        ...
        /// <param name="page">The number of the page returned, starting with 1 (optional, default to 1)</param>
        /// <param name="order">A comma separated list of sorting requirements in priority order, each entry matching PROPERTY_NAME:[ASC|DESC] (optional, default to 1)</param>
        /// <returns>ApiResponse of PageCampaignResource</returns>
        ApiResponse<PageCampaignResource> GetCampaignsUsingGETWithHttpInfo (bool? filterActive = null, int? size = null, int? page = null, string order = null);
        /// <summary>
        ...
        ApiResponse<PageChallengeResource> GetChallengesUsingGETWithHttpInfo (long? id);
        /// <summary>
        ...
        System.Threading.Tasks.Task<PageTemplateResource> GetCampaignTemplatesUsingGETAsync (int? size = null, int? page = null, string order = null);
        ...
        System.Threading.Tasks.Task<ApiResponse<PageTemplateResource>> GetCampaignTemplatesUsingGETAsyncWithHttpInfo (int? size = null, int? page = null, string order = null);
        /// <summary>
        /// Returns a single campaign
        /// </summary>
        /// <remarks>
        ...
        /// <param name="page">The number of the page returned, starting with 1 (optional, default to 1)</param>
        /// <param name="order">A comma separated list of sorting requirements in priority order, each entry matching PROPERTY_NAME:[ASC|DESC] (optional, default to 1)</param>
        /// <returns>Task of PageCampaignResource</returns>
        System.Threading.Tasks.Task<PageCampaignResource> GetCampaignsUsingGETAsync (bool? filterActive = null, int? size = null, int? page = null, string order = null);
        ...
        /// <param name="page">The number of the page returned, starting with 1 (optional, default to 1)</param>
        /// <param name="order">A comma separated list of sorting requirements in priority order, each entry matching PROPERTY_NAME:[ASC|DESC] (optional, default to 1)</param>
        /// <returns>Task of ApiResponse (PageCampaignResource)</returns>
        System.Threading.Tasks.Task<ApiResponse<PageCampaignResource>> GetCampaignsUsingGETAsyncWithHttpInfo (bool? filterActive = null, int? size = null, int? page = null, string order = null);
        /// <summary>
        /// List the challenges associated with a campaign
        /// </summary>
        /// <remarks>
        ...
        System.Threading.Tasks.Task<PageChallengeResource> GetChallengesUsingGETAsync (long? id);
        ...
        System.Threading.Tasks.Task<ApiResponse<PageChallengeResource>> GetChallengesUsingGETAsyncWithHttpInfo (long? id);
        /// <summary>
        /// Remove a challenge from a campaign
        /// </summary>
        /// <remarks>
    ...
    public partial class CampaignsApi : ICampaignsApi
    {
        ...
        /// <param name="order">a comma separated list of sorting requirements in priority order, each entry matching PROPERTY_NAME:[ASC|DESC] (optional, default to 1)</param>
        /// <returns>PageTemplateResource</returns>
        public PageTemplateResource GetCampaignTemplatesUsingGET (int? size = null, int? page = null, string order = null)
        {
             ApiResponse<PageTemplateResource> localVarResponse = GetCampaignTemplatesUsingGETWithHttpInfo(size, page, order);
             return localVarResponse.Data;
        }
        ...
        /// <param name="order">a comma separated list of sorting requirements in priority order, each entry matching PROPERTY_NAME:[ASC|DESC] (optional, default to 1)</param>
        /// <returns>ApiResponse of PageTemplateResource</returns>
        public ApiResponse< PageTemplateResource > GetCampaignTemplatesUsingGETWithHttpInfo (int? size = null, int? page = null, string order = null)
        {
        ...
        /// <param name="order">a comma separated list of sorting requirements in priority order, each entry matching PROPERTY_NAME:[ASC|DESC] (optional, default to 1)</param>
        /// <returns>Task of PageTemplateResource</returns>
        public async System.Threading.Tasks.Task<PageTemplateResource> GetCampaignTemplatesUsingGETAsync (int? size = null, int? page = null, string order = null)
        {
             ApiResponse<PageTemplateResource> localVarResponse = await GetCampaignTemplatesUsingGETAsyncWithHttpInfo(size, page, order);
             return localVarResponse.Data;
        ...
        /// <param name="order">a comma separated list of sorting requirements in priority order, each entry matching PROPERTY_NAME:[ASC|DESC] (optional, default to 1)</param>
        /// <returns>Task of ApiResponse (PageTemplateResource)</returns>
        public async System.Threading.Tasks.Task<ApiResponse<PageTemplateResource>> GetCampaignTemplatesUsingGETAsyncWithHttpInfo (int? size = null, int? page = null, string order = null)
        {
        ...
        /// <param name="order">A comma separated list of sorting requirements in priority order, each entry matching PROPERTY_NAME:[ASC|DESC] (optional, default to 1)</param>
        /// <returns>PageCampaignResource</returns>
        public PageCampaignResource GetCampaignsUsingGET (bool? filterActive = null, int? size = null, int? page = null, string order = null)
        {
             ApiResponse<PageCampaignResource> localVarResponse = GetCampaignsUsingGETWithHttpInfo(filterActive, size, page, order);
             return localVarResponse.Data;
        }
        ...
        /// <param name="order">A comma separated list of sorting requirements in priority order, each entry matching PROPERTY_NAME:[ASC|DESC] (optional, default to 1)</param>
        /// <returns>ApiResponse of PageCampaignResource</returns>
        public ApiResponse< PageCampaignResource > GetCampaignsUsingGETWithHttpInfo (bool? filterActive = null, int? size = null, int? page = null, string order = null)
        {
            ...
            return new ApiResponse<PageCampaignResource>(localVarStatusCode,
                localVarResponse.Headers.ToDictionary(x => x.Name, x => x.Value.ToString()),
                (PageCampaignResource) Configuration.ApiClient.Deserialize(localVarResponse, typeof(PageCampaignResource)));
        ...
        /// <param name="order">A comma separated list of sorting requirements in priority order, each entry matching PROPERTY_NAME:[ASC|DESC] (optional, default to 1)</param>
        /// <returns>Task of PageCampaignResource</returns>
        public async System.Threading.Tasks.Task<PageCampaignResource> GetCampaignsUsingGETAsync (bool? filterActive = null, int? size = null, int? page = null, string order = null)
        {
             ApiResponse<PageCampaignResource> localVarResponse = await GetCampaignsUsingGETAsyncWithHttpInfo(filterActive, size, page, order);
             return localVarResponse.Data;
        ...
        /// <param name="order">A comma separated list of sorting requirements in priority order, each entry matching PROPERTY_NAME:[ASC|DESC] (optional, default to 1)</param>
        /// <returns>Task of ApiResponse (PageCampaignResource)</returns>
        public async System.Threading.Tasks.Task<ApiResponse<PageCampaignResource>> GetCampaignsUsingGETAsyncWithHttpInfo (bool? filterActive = null, int? size = null, int? page = null, string order = null)
        {
        ...
        /// <param name="id">The campaign id</param>
        /// <returns>PageChallengeResource</returns>
        public PageChallengeResource GetChallengesUsingGET (long? id)
        {
             ApiResponse<PageChallengeResource> localVarResponse = GetChallengesUsingGETWithHttpInfo(id);
             return localVarResponse.Data;
        }
        ...
        /// <param name="id">The campaign id</param>
        /// <returns>ApiResponse of PageChallengeResource</returns>
        public ApiResponse< PageChallengeResource > GetChallengesUsingGETWithHttpInfo (long? id)
        {
            // verify the required parameter 'id' is set
            if (id == null)
        ...
        /// <param name="id">The campaign id</param>
        /// <returns>Task of PageChallengeResource</returns>
        public async System.Threading.Tasks.Task<PageChallengeResource> GetChallengesUsingGETAsync (long? id)
        {
             ApiResponse<PageChallengeResource> localVarResponse = await GetChallengesUsingGETAsyncWithHttpInfo(id);
             return localVarResponse.Data;
        ...
        /// <param name="id">The campaign id</param>
        /// <returns>Task of ApiResponse (PageChallengeResource)</returns>
        public async System.Threading.Tasks.Task<ApiResponse<PageChallengeResource>> GetChallengesUsingGETAsyncWithHttpInfo (long? id)
        {
            // verify the required parameter 'id' is set
            if (id == null)
                throw new ApiException(400, "Missing required parameter 'id' when calling CampaignsApi->GetChallengesUsingGET");
