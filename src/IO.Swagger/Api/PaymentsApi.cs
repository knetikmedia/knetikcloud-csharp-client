...
namespace IO.Swagger.Api
{
    ...
    public interface IPaymentsApi : IApiAccessor
    {
        ...
        /// <param name="paymentMethod">The updated payment method data (optional)</param>
        /// <returns>ApiResponse of Object(void)</returns>
        ApiResponse<Object> UpdatePaymentMethodWithHttpInfo (int? userId, int? id, PaymentMethodResource paymentMethod = null);
        ...
        /// <param name="paymentMethod">The updated payment method data (optional)</param>
        /// <returns>Task of void</returns>
        System.Threading.Tasks.Task UpdatePaymentMethodAsync (int? userId, int? id, PaymentMethodResource paymentMethod = null);
        ...
        /// <param name="paymentMethod">The updated payment method data (optional)</param>
        /// <returns>Task of ApiResponse</returns>
        System.Threading.Tasks.Task<ApiResponse<Object>> UpdatePaymentMethodAsyncWithHttpInfo (int? userId, int? id, PaymentMethodResource paymentMethod = null);
    ...
    public partial class PaymentsApi : IPaymentsApi
    {
        ...
        /// <param name="paymentMethod">The updated payment method data (optional)</param>
        /// <returns></returns>
        public void UpdatePaymentMethod (int? userId, int? id, PaymentMethodResource paymentMethod = null)
        {
        ...
        /// <param name="paymentMethod">The updated payment method data (optional)</param>
        /// <returns>ApiResponse of Object(void)</returns>
        public ApiResponse<Object> UpdatePaymentMethodWithHttpInfo (int? userId, int? id, PaymentMethodResource paymentMethod = null)
        {
            // verify the required parameter 'userId' is set
            if (userId == null)
        ...
        /// <param name="paymentMethod">The updated payment method data (optional)</param>
        /// <returns>Task of void</returns>
        public async System.Threading.Tasks.Task UpdatePaymentMethodAsync (int? userId, int? id, PaymentMethodResource paymentMethod = null)
        {
             await UpdatePaymentMethodAsyncWithHttpInfo(userId, id, paymentMethod);
        ...
        /// <param name="paymentMethod">The updated payment method data (optional)</param>
        /// <returns>Task of ApiResponse</returns>
        public async System.Threading.Tasks.Task<ApiResponse<Object>> UpdatePaymentMethodAsyncWithHttpInfo (int? userId, int? id, PaymentMethodResource paymentMethod = null)
        {
            // verify the required parameter 'userId' is set
            if (userId == null)
                throw new ApiException(400, "Missing required parameter 'userId' when calling PaymentsApi->UpdatePaymentMethod");
