...
namespace IO.Swagger.Api
{
    ...
    public interface IReportingUsersApi : IApiAccessor
    {
        ...
        ApiResponse<PageResourceAggregateCountResource> ExecutiveRevenueItemSalesUsingGET1WithHttpInfo (string granularity = null, long? startDate = null, long? endDate = null);
        ...
        System.Threading.Tasks.Task<PageResourceAggregateCountResource> ExecutiveRevenueItemSalesUsingGET1Async (string granularity = null, long? startDate = null, long? endDate = null);
        ...
        System.Threading.Tasks.Task<ApiResponse<PageResourceAggregateCountResource>> ExecutiveRevenueItemSalesUsingGET1AsyncWithHttpInfo (string granularity = null, long? startDate = null, long? endDate = null);
    ...
    public partial class ReportingUsersApi : IReportingUsersApi
    {
        ...
        /// <param name="endDate">The end of the time range to aggregate, unix timestamp in seconds. Default is end of time (optional)</param>
        /// <returns>PageResourceAggregateCountResource</returns>
        public PageResourceAggregateCountResource ExecutiveRevenueItemSalesUsingGET1 (string granularity = null, long? startDate = null, long? endDate = null)
        {
             ApiResponse<PageResourceAggregateCountResource> localVarResponse = ExecutiveRevenueItemSalesUsingGET1WithHttpInfo(granularity, startDate, endDate);
        ...
        /// <param name="endDate">The end of the time range to aggregate, unix timestamp in seconds. Default is end of time (optional)</param>
        /// <returns>ApiResponse of PageResourceAggregateCountResource</returns>
        public ApiResponse< PageResourceAggregateCountResource > ExecutiveRevenueItemSalesUsingGET1WithHttpInfo (string granularity = null, long? startDate = null, long? endDate = null)
        {
        ...
        /// <param name="endDate">The end of the time range to aggregate, unix timestamp in seconds. Default is end of time (optional)</param>
        /// <returns>Task of PageResourceAggregateCountResource</returns>
        public async System.Threading.Tasks.Task<PageResourceAggregateCountResource> ExecutiveRevenueItemSalesUsingGET1Async (string granularity = null, long? startDate = null, long? endDate = null)
        {
             ApiResponse<PageResourceAggregateCountResource> localVarResponse = await ExecutiveRevenueItemSalesUsingGET1AsyncWithHttpInfo(granularity, startDate, endDate);
             return localVarResponse.Data;
        ...
        /// <param name="endDate">The end of the time range to aggregate, unix timestamp in seconds. Default is end of time (optional)</param>
        /// <returns>Task of ApiResponse (PageResourceAggregateCountResource)</returns>
        public async System.Threading.Tasks.Task<ApiResponse<PageResourceAggregateCountResource>> ExecutiveRevenueItemSalesUsingGET1AsyncWithHttpInfo (string granularity = null, long? startDate = null, long? endDate = null)
        {
