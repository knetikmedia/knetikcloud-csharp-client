...
namespace IO.Swagger.Api
{
    ...
    public interface IStoreSubscriptionsApi : IApiAccessor
    {
        ...
        /// <param name="subscriptionTemplateResource">The subscription template resource object (optional)</param>
        /// <returns>ApiResponse of Object(void)</returns>
        ApiResponse<Object> UpdateSubscriptionTemplateWithHttpInfo (string id, SubscriptionTemplateResource subscriptionTemplateResource = null);
        ...
        /// <param name="subscriptionTemplateResource">The subscription template resource object (optional)</param>
        /// <returns>Task of void</returns>
        System.Threading.Tasks.Task UpdateSubscriptionTemplateAsync (string id, SubscriptionTemplateResource subscriptionTemplateResource = null);
        ...
        /// <param name="subscriptionTemplateResource">The subscription template resource object (optional)</param>
        /// <returns>Task of ApiResponse</returns>
        System.Threading.Tasks.Task<ApiResponse<Object>> UpdateSubscriptionTemplateAsyncWithHttpInfo (string id, SubscriptionTemplateResource subscriptionTemplateResource = null);
    ...
    public partial class StoreSubscriptionsApi : IStoreSubscriptionsApi
    {
        ...
        /// <param name="subscriptionTemplateResource">The subscription template resource object (optional)</param>
        /// <returns></returns>
        public void UpdateSubscriptionTemplate (string id, SubscriptionTemplateResource subscriptionTemplateResource = null)
        {
        ...
        /// <param name="subscriptionTemplateResource">The subscription template resource object (optional)</param>
        /// <returns>ApiResponse of Object(void)</returns>
        public ApiResponse<Object> UpdateSubscriptionTemplateWithHttpInfo (string id, SubscriptionTemplateResource subscriptionTemplateResource = null)
        {
            // verify the required parameter 'id' is set
            if (id == null)
        ...
        /// <param name="subscriptionTemplateResource">The subscription template resource object (optional)</param>
        /// <returns>Task of void</returns>
        public async System.Threading.Tasks.Task UpdateSubscriptionTemplateAsync (string id, SubscriptionTemplateResource subscriptionTemplateResource = null)
        {
             await UpdateSubscriptionTemplateAsyncWithHttpInfo(id, subscriptionTemplateResource);
        ...
        /// <param name="subscriptionTemplateResource">The subscription template resource object (optional)</param>
        /// <returns>Task of ApiResponse</returns>
        public async System.Threading.Tasks.Task<ApiResponse<Object>> UpdateSubscriptionTemplateAsyncWithHttpInfo (string id, SubscriptionTemplateResource subscriptionTemplateResource = null)
        {
            // verify the required parameter 'id' is set
            if (id == null)
                throw new ApiException(400, "Missing required parameter 'id' when calling StoreSubscriptionsApi->UpdateSubscriptionTemplate");
