...
namespace IO.Swagger.Api
{
    ...
    public interface IGamificationLevelingApi : IApiAccessor
    {
        ...
        /// <returns>PageLevelingResource</returns>
        ...
        /// <param name="page">The number of the page returned, starting with 1 (optional, default to 1)</param>
        /// <param name="order">A comma separated list of sorting requirements in priority order, each entry matching PROPERTY_NAME:[ASC|DESC] (optional, default to name:ASC)</param>
        /// <returns>ApiResponse of PageLevelingResource</returns>
        ApiResponse<PageLevelingResource> GetLevelsUsingGETWithHttpInfo (string filterName = null, int? size = null, int? page = null, string order = null);
        /// <summary>
        ...
        /// <exception cref="IO.Swagger.Client.ApiException">Thrown when fails to make API call</exception>
        /// <param name="userId">The id of the user</param>
        /// <returns>PageUserLevelingResource</returns>
        ...
        /// <exception cref="IO.Swagger.Client.ApiException">Thrown when fails to make API call</exception>
        /// <param name="userId">The id of the user</param>
        /// <returns>ApiResponse of PageUserLevelingResource</returns>
        ApiResponse<PageUserLevelingResource> GetUserLevelsUsingGETWithHttpInfo (int? userId);
        /// <summary>
        /// Update a level
        /// </summary>
        /// <remarks>
        ...
        /// <param name="page">The number of the page returned, starting with 1 (optional, default to 1)</param>
        /// <param name="order">A comma separated list of sorting requirements in priority order, each entry matching PROPERTY_NAME:[ASC|DESC] (optional, default to name:ASC)</param>
        /// <returns>Task of PageLevelingResource</returns>
        System.Threading.Tasks.Task<PageLevelingResource> GetLevelsUsingGETAsync (string filterName = null, int? size = null, int? page = null, string order = null);
        ...
        /// <param name="page">The number of the page returned, starting with 1 (optional, default to 1)</param>
        /// <param name="order">A comma separated list of sorting requirements in priority order, each entry matching PROPERTY_NAME:[ASC|DESC] (optional, default to name:ASC)</param>
        /// <returns>Task of ApiResponse (PageLevelingResource)</returns>
        System.Threading.Tasks.Task<ApiResponse<PageLevelingResource>> GetLevelsUsingGETAsyncWithHttpInfo (string filterName = null, int? size = null, int? page = null, string order = null);
        /// <summary>
        /// Get a user&#39;s progress for a given level schema
        /// </summary>
        /// <remarks>
        ...
        /// <exception cref="IO.Swagger.Client.ApiException">Thrown when fails to make API call</exception>
        /// <param name="userId">The id of the user</param>
        /// <returns>Task of PageUserLevelingResource</returns>
        System.Threading.Tasks.Task<PageUserLevelingResource> GetUserLevelsUsingGETAsync (int? userId);
        ...
        /// <exception cref="IO.Swagger.Client.ApiException">Thrown when fails to make API call</exception>
        /// <param name="userId">The id of the user</param>
        /// <returns>Task of ApiResponse (PageUserLevelingResource)</returns>
        System.Threading.Tasks.Task<ApiResponse<PageUserLevelingResource>> GetUserLevelsUsingGETAsyncWithHttpInfo (int? userId);
        /// <summary>
        /// Update a level
        /// </summary>
        /// <remarks>
    ...
    public partial class GamificationLevelingApi : IGamificationLevelingApi
    {
        ...
        /// <param name="order">A comma separated list of sorting requirements in priority order, each entry matching PROPERTY_NAME:[ASC|DESC] (optional, default to name:ASC)</param>
        /// <returns>PageLevelingResource</returns>
        public PageLevelingResource GetLevelsUsingGET (string filterName = null, int? size = null, int? page = null, string order = null)
        {
             ApiResponse<PageLevelingResource> localVarResponse = GetLevelsUsingGETWithHttpInfo(filterName, size, page, order);
             return localVarResponse.Data;
        }
        ...
        /// <param name="order">A comma separated list of sorting requirements in priority order, each entry matching PROPERTY_NAME:[ASC|DESC] (optional, default to name:ASC)</param>
        /// <returns>ApiResponse of PageLevelingResource</returns>
        public ApiResponse< PageLevelingResource > GetLevelsUsingGETWithHttpInfo (string filterName = null, int? size = null, int? page = null, string order = null)
        {
            ...
            return new ApiResponse<PageLevelingResource>(localVarStatusCode,
                localVarResponse.Headers.ToDictionary(x => x.Name, x => x.Value.ToString()),
                (PageLevelingResource) Configuration.ApiClient.Deserialize(localVarResponse, typeof(PageLevelingResource)));
        ...
        /// <param name="order">A comma separated list of sorting requirements in priority order, each entry matching PROPERTY_NAME:[ASC|DESC] (optional, default to name:ASC)</param>
        /// <returns>Task of PageLevelingResource</returns>
        public async System.Threading.Tasks.Task<PageLevelingResource> GetLevelsUsingGETAsync (string filterName = null, int? size = null, int? page = null, string order = null)
        {
             ApiResponse<PageLevelingResource> localVarResponse = await GetLevelsUsingGETAsyncWithHttpInfo(filterName, size, page, order);
             return localVarResponse.Data;
        ...
        /// <param name="order">A comma separated list of sorting requirements in priority order, each entry matching PROPERTY_NAME:[ASC|DESC] (optional, default to name:ASC)</param>
        /// <returns>Task of ApiResponse (PageLevelingResource)</returns>
        public async System.Threading.Tasks.Task<ApiResponse<PageLevelingResource>> GetLevelsUsingGETAsyncWithHttpInfo (string filterName = null, int? size = null, int? page = null, string order = null)
        {
        ...
        /// <param name="userId">The id of the user</param>
        /// <returns>PageUserLevelingResource</returns>
        public PageUserLevelingResource GetUserLevelsUsingGET (int? userId)
        {
             ApiResponse<PageUserLevelingResource> localVarResponse = GetUserLevelsUsingGETWithHttpInfo(userId);
             return localVarResponse.Data;
        }
        ...
        /// <param name="userId">The id of the user</param>
        /// <returns>ApiResponse of PageUserLevelingResource</returns>
        public ApiResponse< PageUserLevelingResource > GetUserLevelsUsingGETWithHttpInfo (int? userId)
        {
            // verify the required parameter 'userId' is set
            if (userId == null)
            ...
            return new ApiResponse<PageUserLevelingResource>(localVarStatusCode,
                localVarResponse.Headers.ToDictionary(x => x.Name, x => x.Value.ToString()),
                (PageUserLevelingResource) Configuration.ApiClient.Deserialize(localVarResponse, typeof(PageUserLevelingResource)));
        ...
        /// <param name="userId">The id of the user</param>
        /// <returns>Task of PageUserLevelingResource</returns>
        public async System.Threading.Tasks.Task<PageUserLevelingResource> GetUserLevelsUsingGETAsync (int? userId)
        {
             ApiResponse<PageUserLevelingResource> localVarResponse = await GetUserLevelsUsingGETAsyncWithHttpInfo(userId);
             return localVarResponse.Data;
        ...
        /// <param name="userId">The id of the user</param>
        /// <returns>Task of ApiResponse (PageUserLevelingResource)</returns>
        public async System.Threading.Tasks.Task<ApiResponse<PageUserLevelingResource>> GetUserLevelsUsingGETAsyncWithHttpInfo (int? userId)
        {
            // verify the required parameter 'userId' is set
            if (userId == null)
                throw new ApiException(400, "Missing required parameter 'userId' when calling GamificationLevelingApi->GetUserLevelsUsingGET");
