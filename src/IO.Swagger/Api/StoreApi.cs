...
namespace IO.Swagger.Api
{
    ...
    public interface IStoreApi : IApiAccessor
    {
        ...
        /// <returns>PageStoreItemTemplateResource</returns>
        ...
        /// <param name="page">The number of the page returned, starting with 1 (optional, default to 1)</param>
        /// <param name="order">A comma separated list of sorting requirements in priority order, each entry matching PROPERTY_NAME:[ASC|DESC] (optional, default to id:ASC)</param>
        /// <returns>ApiResponse of PageStoreItemTemplateResource</returns>
        ApiResponse<PageStoreItemTemplateResource> GetItemTemplatesUsingGETWithHttpInfo (int? size = null, int? page = null, string order = null);
        /// <summary>
        ...
        /// <param name="page">The number of the page returned, starting with 1 (optional, default to 1)</param>
        /// <param name="order">A comma separated list of sorting requirements in priority order, each entry matching PROPERTY_NAME:[ASC|DESC] (optional, default to id:ASC)</param>
        /// <returns>Task of PageStoreItemTemplateResource</returns>
        System.Threading.Tasks.Task<PageStoreItemTemplateResource> GetItemTemplatesUsingGETAsync (int? size = null, int? page = null, string order = null);
        ...
        /// <param name="page">The number of the page returned, starting with 1 (optional, default to 1)</param>
        /// <param name="order">A comma separated list of sorting requirements in priority order, each entry matching PROPERTY_NAME:[ASC|DESC] (optional, default to id:ASC)</param>
        /// <returns>Task of ApiResponse (PageStoreItemTemplateResource)</returns>
        System.Threading.Tasks.Task<ApiResponse<PageStoreItemTemplateResource>> GetItemTemplatesUsingGETAsyncWithHttpInfo (int? size = null, int? page = null, string order = null);
        /// <summary>
        /// Get a single store item
        /// </summary>
        /// <remarks>
    ...
    public partial class StoreApi : IStoreApi
    {
        ...
        /// <param name="order">A comma separated list of sorting requirements in priority order, each entry matching PROPERTY_NAME:[ASC|DESC] (optional, default to id:ASC)</param>
        /// <returns>PageStoreItemTemplateResource</returns>
        public PageStoreItemTemplateResource GetItemTemplatesUsingGET (int? size = null, int? page = null, string order = null)
        {
             ApiResponse<PageStoreItemTemplateResource> localVarResponse = GetItemTemplatesUsingGETWithHttpInfo(size, page, order);
             return localVarResponse.Data;
        }
        ...
        /// <param name="order">A comma separated list of sorting requirements in priority order, each entry matching PROPERTY_NAME:[ASC|DESC] (optional, default to id:ASC)</param>
        /// <returns>ApiResponse of PageStoreItemTemplateResource</returns>
        public ApiResponse< PageStoreItemTemplateResource > GetItemTemplatesUsingGETWithHttpInfo (int? size = null, int? page = null, string order = null)
        {
            ...
            return new ApiResponse<PageStoreItemTemplateResource>(localVarStatusCode,
                localVarResponse.Headers.ToDictionary(x => x.Name, x => x.Value.ToString()),
                (PageStoreItemTemplateResource) Configuration.ApiClient.Deserialize(localVarResponse, typeof(PageStoreItemTemplateResource)));
        ...
        /// <param name="order">A comma separated list of sorting requirements in priority order, each entry matching PROPERTY_NAME:[ASC|DESC] (optional, default to id:ASC)</param>
        /// <returns>Task of PageStoreItemTemplateResource</returns>
        public async System.Threading.Tasks.Task<PageStoreItemTemplateResource> GetItemTemplatesUsingGETAsync (int? size = null, int? page = null, string order = null)
        {
             ApiResponse<PageStoreItemTemplateResource> localVarResponse = await GetItemTemplatesUsingGETAsyncWithHttpInfo(size, page, order);
             return localVarResponse.Data;
        ...
        /// <param name="order">A comma separated list of sorting requirements in priority order, each entry matching PROPERTY_NAME:[ASC|DESC] (optional, default to id:ASC)</param>
        /// <returns>Task of ApiResponse (PageStoreItemTemplateResource)</returns>
        public async System.Threading.Tasks.Task<ApiResponse<PageStoreItemTemplateResource>> GetItemTemplatesUsingGETAsyncWithHttpInfo (int? size = null, int? page = null, string order = null)
        {
