...
namespace IO.Swagger.Api
{
    ...
    public interface IUsersAddressesApi : IApiAccessor
    {
        ...
        /// <param name="savedAddressResource">The saved address resource object (optional)</param>
        /// <returns>ApiResponse of Object(void)</returns>
        ApiResponse<Object> UpdateAddressWithHttpInfo (string userId, int? id, SavedAddressResource savedAddressResource = null);
        ...
        /// <param name="savedAddressResource">The saved address resource object (optional)</param>
        /// <returns>Task of void</returns>
        System.Threading.Tasks.Task UpdateAddressAsync (string userId, int? id, SavedAddressResource savedAddressResource = null);
        ...
        /// <param name="savedAddressResource">The saved address resource object (optional)</param>
        /// <returns>Task of ApiResponse</returns>
        System.Threading.Tasks.Task<ApiResponse<Object>> UpdateAddressAsyncWithHttpInfo (string userId, int? id, SavedAddressResource savedAddressResource = null);
    ...
    public partial class UsersAddressesApi : IUsersAddressesApi
    {
        ...
        /// <param name="savedAddressResource">The saved address resource object (optional)</param>
        /// <returns></returns>
        public void UpdateAddress (string userId, int? id, SavedAddressResource savedAddressResource = null)
        {
        ...
        /// <param name="savedAddressResource">The saved address resource object (optional)</param>
        /// <returns>ApiResponse of Object(void)</returns>
        public ApiResponse<Object> UpdateAddressWithHttpInfo (string userId, int? id, SavedAddressResource savedAddressResource = null)
        {
            // verify the required parameter 'userId' is set
            if (userId == null)
        ...
        /// <param name="savedAddressResource">The saved address resource object (optional)</param>
        /// <returns>Task of void</returns>
        public async System.Threading.Tasks.Task UpdateAddressAsync (string userId, int? id, SavedAddressResource savedAddressResource = null)
        {
             await UpdateAddressAsyncWithHttpInfo(userId, id, savedAddressResource);
        ...
        /// <param name="savedAddressResource">The saved address resource object (optional)</param>
        /// <returns>Task of ApiResponse</returns>
        public async System.Threading.Tasks.Task<ApiResponse<Object>> UpdateAddressAsyncWithHttpInfo (string userId, int? id, SavedAddressResource savedAddressResource = null)
        {
            // verify the required parameter 'userId' is set
            if (userId == null)
                throw new ApiException(400, "Missing required parameter 'userId' when calling UsersAddressesApi->UpdateAddress");
