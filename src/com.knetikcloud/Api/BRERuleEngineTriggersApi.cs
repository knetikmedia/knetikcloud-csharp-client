...
namespace com.knetikcloud.Api
{
    ...
    public interface IBRERuleEngineTriggersApi : IApiAccessor
    {
        ...
        System.Threading.Tasks.Task<PageResourceBreTriggerResource> GetBRETriggersAsync (bool? filterSystem = null, string filterCategory = null, string filterTags = null, string filterName = null, string filterSearch = null, int? size = null, int? page = null);
        ...
        System.Threading.Tasks.Task<ApiResponse<PageResourceBreTriggerResource>> GetBRETriggersAsyncWithHttpInfo (bool? filterSystem = null, string filterCategory = null, string filterTags = null, string filterName = null, string filterSearch = null, int? size = null, int? page = null);
        /// <summary>
        /// Update a trigger
        /// </summary>
        /// <remarks>
    ...
    public partial class BRERuleEngineTriggersApi : IBRERuleEngineTriggersApi
    {
        ...
        /// <param name="page">The number of the page returned, starting with 1 (optional, default to 1)</param>
        /// <returns>Task of PageResourceBreTriggerResource</returns>
        public async System.Threading.Tasks.Task<PageResourceBreTriggerResource> GetBRETriggersAsync (bool? filterSystem = null, string filterCategory = null, string filterTags = null, string filterName = null, string filterSearch = null, int? size = null, int? page = null)
        {
             ApiResponse<PageResourceBreTriggerResource> localVarResponse = await GetBRETriggersAsyncWithHttpInfo(filterSystem, filterCategory, filterTags, filterName, filterSearch, size, page);
             return localVarResponse.Data;
        ...
        /// <param name="page">The number of the page returned, starting with 1 (optional, default to 1)</param>
        /// <returns>Task of ApiResponse (PageResourceBreTriggerResource)</returns>
        public async System.Threading.Tasks.Task<ApiResponse<PageResourceBreTriggerResource>> GetBRETriggersAsyncWithHttpInfo (bool? filterSystem = null, string filterCategory = null, string filterTags = null, string filterName = null, string filterSearch = null, int? size = null, int? page = null)
        {
