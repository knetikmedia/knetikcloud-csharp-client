...
namespace com.knetikcloud.Api
{
    ...
    public interface IPaymentsApi : IApiAccessor
    {
        ...
        /// <exception cref="com.knetikcloud.Client.ApiException">Thrown when fails to make API call</exception>
        /// <param name="id">ID of the payment method type being retrieved</param>
        /// <returns>Task of PaymentMethodTypeResource</returns>
        System.Threading.Tasks.Task<PaymentMethodTypeResource> GetPaymentMethodTypeAsync (int? id);
        ...
        /// <exception cref="com.knetikcloud.Client.ApiException">Thrown when fails to make API call</exception>
        /// <param name="id">ID of the payment method type being retrieved</param>
        /// <returns>Task of ApiResponse (PaymentMethodTypeResource)</returns>
        System.Threading.Tasks.Task<ApiResponse<PaymentMethodTypeResource>> GetPaymentMethodTypeAsyncWithHttpInfo (int? id);
        /// <summary>
        /// Get all payment method types
        /// </summary>
        /// <remarks>
        ...
        /// <param name="page">The number of the page returned, starting with 1 (optional, default to 1)</param>
        /// <param name="order">a comma separated list of sorting requirements in priority order, each entry matching PROPERTY_NAME:[ASC|DESC] (optional, default to id:ASC)</param>
        /// <returns>Task of PageResourcePaymentMethodTypeResource</returns>
        System.Threading.Tasks.Task<PageResourcePaymentMethodTypeResource> GetPaymentMethodTypesAsync (string filterName = null, int? size = null, int? page = null, string order = null);
        ...
        /// <param name="page">The number of the page returned, starting with 1 (optional, default to 1)</param>
        /// <param name="order">a comma separated list of sorting requirements in priority order, each entry matching PROPERTY_NAME:[ASC|DESC] (optional, default to id:ASC)</param>
        /// <returns>Task of ApiResponse (PageResourcePaymentMethodTypeResource)</returns>
        System.Threading.Tasks.Task<ApiResponse<PageResourcePaymentMethodTypeResource>> GetPaymentMethodTypesAsyncWithHttpInfo (string filterName = null, int? size = null, int? page = null, string order = null);
        /// <summary>
        /// Get all payment methods for a user
        /// </summary>
        /// <remarks>
        ...
        System.Threading.Tasks.Task<List<PaymentMethodResource>> GetPaymentMethodsAsync (int? userId, string filterName = null, string filterPaymentType = null, int? filterPaymentMethodTypeId = null, string filterPaymentMethodTypeName = null, int? size = null, int? page = null, string order = null);
        ...
        System.Threading.Tasks.Task<ApiResponse<List<PaymentMethodResource>>> GetPaymentMethodsAsyncWithHttpInfo (int? userId, string filterName = null, string filterPaymentType = null, int? filterPaymentMethodTypeId = null, string filterPaymentMethodTypeName = null, int? size = null, int? page = null, string order = null);
        /// <summary>
        /// Authorize payment of an invoice for later capture
        /// </summary>
        /// <remarks>
    ...
    public partial class PaymentsApi : IPaymentsApi
    {
        ...
        /// <param name="id">ID of the payment method type being retrieved</param>
        /// <returns>Task of PaymentMethodTypeResource</returns>
        public async System.Threading.Tasks.Task<PaymentMethodTypeResource> GetPaymentMethodTypeAsync (int? id)
        {
             ApiResponse<PaymentMethodTypeResource> localVarResponse = await GetPaymentMethodTypeAsyncWithHttpInfo(id);
             return localVarResponse.Data;
        ...
        /// <param name="id">ID of the payment method type being retrieved</param>
        /// <returns>Task of ApiResponse (PaymentMethodTypeResource)</returns>
        public async System.Threading.Tasks.Task<ApiResponse<PaymentMethodTypeResource>> GetPaymentMethodTypeAsyncWithHttpInfo (int? id)
        {
            // verify the required parameter 'id' is set
            if (id == null)
                throw new ApiException(400, "Missing required parameter 'id' when calling PaymentsApi->GetPaymentMethodType");
        ...
        /// <param name="order">a comma separated list of sorting requirements in priority order, each entry matching PROPERTY_NAME:[ASC|DESC] (optional, default to id:ASC)</param>
        /// <returns>Task of PageResourcePaymentMethodTypeResource</returns>
        public async System.Threading.Tasks.Task<PageResourcePaymentMethodTypeResource> GetPaymentMethodTypesAsync (string filterName = null, int? size = null, int? page = null, string order = null)
        {
             ApiResponse<PageResourcePaymentMethodTypeResource> localVarResponse = await GetPaymentMethodTypesAsyncWithHttpInfo(filterName, size, page, order);
             return localVarResponse.Data;
        ...
        /// <param name="order">a comma separated list of sorting requirements in priority order, each entry matching PROPERTY_NAME:[ASC|DESC] (optional, default to id:ASC)</param>
        /// <returns>Task of ApiResponse (PageResourcePaymentMethodTypeResource)</returns>
        public async System.Threading.Tasks.Task<ApiResponse<PageResourcePaymentMethodTypeResource>> GetPaymentMethodTypesAsyncWithHttpInfo (string filterName = null, int? size = null, int? page = null, string order = null)
        {
        ...
        /// <param name="order">a comma separated list of sorting requirements in priority order, each entry matching PROPERTY_NAME:[ASC|DESC] (optional, default to id:ASC)</param>
        /// <returns>Task of List&lt;PaymentMethodResource&gt;</returns>
        public async System.Threading.Tasks.Task<List<PaymentMethodResource>> GetPaymentMethodsAsync (int? userId, string filterName = null, string filterPaymentType = null, int? filterPaymentMethodTypeId = null, string filterPaymentMethodTypeName = null, int? size = null, int? page = null, string order = null)
        {
             ApiResponse<List<PaymentMethodResource>> localVarResponse = await GetPaymentMethodsAsyncWithHttpInfo(userId, filterName, filterPaymentType, filterPaymentMethodTypeId, filterPaymentMethodTypeName, size, page, order);
             return localVarResponse.Data;
        ...
        /// <param name="order">a comma separated list of sorting requirements in priority order, each entry matching PROPERTY_NAME:[ASC|DESC] (optional, default to id:ASC)</param>
        /// <returns>Task of ApiResponse (List&lt;PaymentMethodResource&gt;)</returns>
        public async System.Threading.Tasks.Task<ApiResponse<List<PaymentMethodResource>>> GetPaymentMethodsAsyncWithHttpInfo (int? userId, string filterName = null, string filterPaymentType = null, int? filterPaymentMethodTypeId = null, string filterPaymentMethodTypeName = null, int? size = null, int? page = null, string order = null)
        {
            // verify the required parameter 'userId' is set
            if (userId == null)
                throw new ApiException(400, "Missing required parameter 'userId' when calling PaymentsApi->GetPaymentMethods");
