...
namespace com.knetikcloud.Api
{
    ...
    public interface IUtilSecurityApi : IApiAccessor
    {
        ...
        System.Threading.Tasks.Task<PageResourceLocationLogResource> GetUserLocationLogAsync (int? userId = null, int? size = null, int? page = null, string order = null);
        ...
        System.Threading.Tasks.Task<ApiResponse<PageResourceLocationLogResource>> GetUserLocationLogAsyncWithHttpInfo (int? userId = null, int? size = null, int? page = null, string order = null);
        /// <summary>
        /// Returns the authentication token details. Use /users endpoint for detailed user&#39;s info
        /// </summary>
        /// <remarks>
    ...
    public partial class UtilSecurityApi : IUtilSecurityApi
    {
        ...
        /// <param name="order">A comma separated list of sorting requirements in priority order, each entry matching PROPERTY_NAME:[ASC|DESC] (optional)</param>
        /// <returns>Task of PageResourceLocationLogResource</returns>
        public async System.Threading.Tasks.Task<PageResourceLocationLogResource> GetUserLocationLogAsync (int? userId = null, int? size = null, int? page = null, string order = null)
        {
             ApiResponse<PageResourceLocationLogResource> localVarResponse = await GetUserLocationLogAsyncWithHttpInfo(userId, size, page, order);
             return localVarResponse.Data;
        ...
        /// <param name="order">A comma separated list of sorting requirements in priority order, each entry matching PROPERTY_NAME:[ASC|DESC] (optional)</param>
        /// <returns>Task of ApiResponse (PageResourceLocationLogResource)</returns>
        public async System.Threading.Tasks.Task<ApiResponse<PageResourceLocationLogResource>> GetUserLocationLogAsyncWithHttpInfo (int? userId = null, int? size = null, int? page = null, string order = null)
        {
