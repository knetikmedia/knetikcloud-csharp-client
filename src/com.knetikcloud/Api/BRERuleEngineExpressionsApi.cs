...
namespace com.knetikcloud.Api
{
    ...
    public interface IBRERuleEngineExpressionsApi : IApiAccessor
    {
        ...
        /// <exception cref="com.knetikcloud.Client.ApiException">Thrown when fails to make API call</exception>
        /// <param name="type">Specifiy the type of expression as returned by the listing endpoint</param>
        /// <returns>Task of ExpressionResource</returns>
        System.Threading.Tasks.Task<ExpressionResource> GetBREExpressionAsync (string type);
        ...
        /// <exception cref="com.knetikcloud.Client.ApiException">Thrown when fails to make API call</exception>
        /// <param name="type">Specifiy the type of expression as returned by the listing endpoint</param>
        /// <returns>Task of ApiResponse (ExpressionResource)</returns>
        System.Threading.Tasks.Task<ApiResponse<ExpressionResource>> GetBREExpressionAsyncWithHttpInfo (string type);
        /// <summary>
        /// Get a list of supported expressions to use in conditions or actions
        /// </summary>
        /// <remarks>
        ...
        /// <exception cref="com.knetikcloud.Client.ApiException">Thrown when fails to make API call</exception>
        /// <param name="filterTypeGroup">Filter for expressions by type group (optional)</param>
        /// <returns>Task of List&lt;ExpressionResource&gt;</returns>
        System.Threading.Tasks.Task<List<ExpressionResource>> GetBREExpressionsAsync (string filterTypeGroup = null);
        ...
        /// <exception cref="com.knetikcloud.Client.ApiException">Thrown when fails to make API call</exception>
        /// <param name="filterTypeGroup">Filter for expressions by type group (optional)</param>
        /// <returns>Task of ApiResponse (List&lt;ExpressionResource&gt;)</returns>
        System.Threading.Tasks.Task<ApiResponse<List<ExpressionResource>>> GetBREExpressionsAsyncWithHttpInfo (string filterTypeGroup = null);
        /// <summary>
        /// Returns the textual representation of an expression
        /// </summary>
        /// <remarks>
        ...
        System.Threading.Tasks.Task<StringWrapper> GetExpressionAsTextAsync (ExpressionResource expression = null);
        ...
        System.Threading.Tasks.Task<ApiResponse<StringWrapper>> GetExpressionAsTextAsyncWithHttpInfo (ExpressionResource expression = null);
    ...
    public partial class BRERuleEngineExpressionsApi : IBRERuleEngineExpressionsApi
    {
        ...
        /// <param name="type">Specifiy the type of expression as returned by the listing endpoint</param>
        /// <returns>Task of ExpressionResource</returns>
        public async System.Threading.Tasks.Task<ExpressionResource> GetBREExpressionAsync (string type)
        {
             ApiResponse<ExpressionResource> localVarResponse = await GetBREExpressionAsyncWithHttpInfo(type);
             return localVarResponse.Data;
        ...
        /// <param name="type">Specifiy the type of expression as returned by the listing endpoint</param>
        /// <returns>Task of ApiResponse (ExpressionResource)</returns>
        public async System.Threading.Tasks.Task<ApiResponse<ExpressionResource>> GetBREExpressionAsyncWithHttpInfo (string type)
        {
            // verify the required parameter 'type' is set
            if (type == null)
                throw new ApiException(400, "Missing required parameter 'type' when calling BRERuleEngineExpressionsApi->GetBREExpression");
        ...
        /// <param name="filterTypeGroup">Filter for expressions by type group (optional)</param>
        /// <returns>Task of List&lt;ExpressionResource&gt;</returns>
        public async System.Threading.Tasks.Task<List<ExpressionResource>> GetBREExpressionsAsync (string filterTypeGroup = null)
        {
             ApiResponse<List<ExpressionResource>> localVarResponse = await GetBREExpressionsAsyncWithHttpInfo(filterTypeGroup);
             return localVarResponse.Data;
        ...
        /// <param name="filterTypeGroup">Filter for expressions by type group (optional)</param>
        /// <returns>Task of ApiResponse (List&lt;ExpressionResource&gt;)</returns>
        public async System.Threading.Tasks.Task<ApiResponse<List<ExpressionResource>>> GetBREExpressionsAsyncWithHttpInfo (string filterTypeGroup = null)
        {
        ...
        /// <param name="expression">The expression resource to be converted (optional)</param>
        /// <returns>Task of StringWrapper</returns>
        public async System.Threading.Tasks.Task<StringWrapper> GetExpressionAsTextAsync (ExpressionResource expression = null)
        {
             ApiResponse<StringWrapper> localVarResponse = await GetExpressionAsTextAsyncWithHttpInfo(expression);
             return localVarResponse.Data;
        ...
        /// <param name="expression">The expression resource to be converted (optional)</param>
        /// <returns>Task of ApiResponse (StringWrapper)</returns>
        public async System.Threading.Tasks.Task<ApiResponse<StringWrapper>> GetExpressionAsTextAsyncWithHttpInfo (ExpressionResource expression = null)
        {
