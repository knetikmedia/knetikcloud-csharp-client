...
namespace com.knetikcloud.Api
{
    ...
    public interface IGamificationLeaderboardsApi : IApiAccessor
    {
        ...
        System.Threading.Tasks.Task<LeaderboardResource> GetLeaderboardAsync (string contextType, string contextId, int? size = null, int? page = null, string order = null);
        ...
        System.Threading.Tasks.Task<ApiResponse<LeaderboardResource>> GetLeaderboardAsyncWithHttpInfo (string contextType, string contextId, int? size = null, int? page = null, string order = null);
        /// <summary>
        /// Retrieves a specific user entry with rank
        /// </summary>
        /// <remarks>
    ...
    public partial class GamificationLeaderboardsApi : IGamificationLeaderboardsApi
    {
        ...
        /// <param name="order">A comma separated list of sorting requirements in priority order, each entry matching PROPERTY_NAME:[ASC|DESC] (optional, default to score:DESC,updated:ASC,user_id:ASC)</param>
        /// <returns>Task of LeaderboardResource</returns>
        public async System.Threading.Tasks.Task<LeaderboardResource> GetLeaderboardAsync (string contextType, string contextId, int? size = null, int? page = null, string order = null)
        {
             ApiResponse<LeaderboardResource> localVarResponse = await GetLeaderboardAsyncWithHttpInfo(contextType, contextId, size, page, order);
             return localVarResponse.Data;
        ...
        /// <param name="order">A comma separated list of sorting requirements in priority order, each entry matching PROPERTY_NAME:[ASC|DESC] (optional, default to score:DESC,updated:ASC,user_id:ASC)</param>
        /// <returns>Task of ApiResponse (LeaderboardResource)</returns>
        public async System.Threading.Tasks.Task<ApiResponse<LeaderboardResource>> GetLeaderboardAsyncWithHttpInfo (string contextType, string contextId, int? size = null, int? page = null, string order = null)
        {
            // verify the required parameter 'contextType' is set
            if (contextType == null)
                throw new ApiException(400, "Missing required parameter 'contextType' when calling GamificationLeaderboardsApi->GetLeaderboard");
