...
namespace com.knetikcloud.Api
{
    ...
    public interface IBRERuleEngineVariablesApi : IApiAccessor
    {
        ...
        /// <param name="size">The number of objects returned per page (optional, default to 25)</param>
        /// <param name="page">The number of the page returned, starting with 1 (optional, default to 1)</param>
        /// <returns>Task of PageResourceSimpleReferenceResourceobject</returns>
        System.Threading.Tasks.Task<PageResourceSimpleReferenceResourceobject> GetBREVariableValuesAsync (string name, string filterName = null, int? size = null, int? page = null);
        ...
        /// <param name="size">The number of objects returned per page (optional, default to 25)</param>
        /// <param name="page">The number of the page returned, starting with 1 (optional, default to 1)</param>
        /// <returns>Task of ApiResponse (PageResourceSimpleReferenceResourceobject)</returns>
        System.Threading.Tasks.Task<ApiResponse<PageResourceSimpleReferenceResourceobject>> GetBREVariableValuesAsyncWithHttpInfo (string name, string filterName = null, int? size = null, int? page = null);
    ...
    public partial class BRERuleEngineVariablesApi : IBRERuleEngineVariablesApi
    {
        ...
        /// <param name="page">The number of the page returned, starting with 1 (optional, default to 1)</param>
        /// <returns>Task of PageResourceSimpleReferenceResourceobject</returns>
        public async System.Threading.Tasks.Task<PageResourceSimpleReferenceResourceobject> GetBREVariableValuesAsync (string name, string filterName = null, int? size = null, int? page = null)
        {
             ApiResponse<PageResourceSimpleReferenceResourceobject> localVarResponse = await GetBREVariableValuesAsyncWithHttpInfo(name, filterName, size, page);
             return localVarResponse.Data;
        ...
        /// <param name="page">The number of the page returned, starting with 1 (optional, default to 1)</param>
        /// <returns>Task of ApiResponse (PageResourceSimpleReferenceResourceobject)</returns>
        public async System.Threading.Tasks.Task<ApiResponse<PageResourceSimpleReferenceResourceobject>> GetBREVariableValuesAsyncWithHttpInfo (string name, string filterName = null, int? size = null, int? page = null)
        {
            // verify the required parameter 'name' is set
            if (name == null)
                throw new ApiException(400, "Missing required parameter 'name' when calling BRERuleEngineVariablesApi->GetBREVariableValues");
