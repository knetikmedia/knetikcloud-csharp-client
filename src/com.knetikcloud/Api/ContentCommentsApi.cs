...
namespace com.knetikcloud.Api
{
    ...
    public interface IContentCommentsApi : IApiAccessor
    {
        ...
        /// <param name="page">The number of the page returned, starting with 1 (optional, default to 1)</param>
        /// <returns>Task of PageResourceCommentResource</returns>
        System.Threading.Tasks.Task<PageResourceCommentResource> SearchCommentsAsync (Object query = null, int? size = null, int? page = null);
        ...
        /// <param name="page">The number of the page returned, starting with 1 (optional, default to 1)</param>
        /// <returns>Task of ApiResponse (PageResourceCommentResource)</returns>
        System.Threading.Tasks.Task<ApiResponse<PageResourceCommentResource>> SearchCommentsAsyncWithHttpInfo (Object query = null, int? size = null, int? page = null);
        /// <summary>
        /// Update a comment
        /// </summary>
        /// <remarks>
        ...
        /// <param name="content">The comment content (optional)</param>
        /// <returns>Task of void</returns>
        System.Threading.Tasks.Task UpdateCommentAsync (long? id, StringWrapper content = null);
        ...
        /// <param name="content">The comment content (optional)</param>
        /// <returns>Task of ApiResponse</returns>
        System.Threading.Tasks.Task<ApiResponse<Object>> UpdateCommentAsyncWithHttpInfo (long? id, StringWrapper content = null);
    ...
    public partial class ContentCommentsApi : IContentCommentsApi
    {
        ...
        /// <param name="page">The number of the page returned, starting with 1 (optional, default to 1)</param>
        /// <returns>Task of PageResourceCommentResource</returns>
        public async System.Threading.Tasks.Task<PageResourceCommentResource> SearchCommentsAsync (Object query = null, int? size = null, int? page = null)
        {
             ApiResponse<PageResourceCommentResource> localVarResponse = await SearchCommentsAsyncWithHttpInfo(query, size, page);
             return localVarResponse.Data;
        ...
        /// <param name="page">The number of the page returned, starting with 1 (optional, default to 1)</param>
        /// <returns>Task of ApiResponse (PageResourceCommentResource)</returns>
        public async System.Threading.Tasks.Task<ApiResponse<PageResourceCommentResource>> SearchCommentsAsyncWithHttpInfo (Object query = null, int? size = null, int? page = null)
        {
        ...
        /// <param name="content">The comment content (optional)</param>
        /// <returns>Task of void</returns>
        public async System.Threading.Tasks.Task UpdateCommentAsync (long? id, StringWrapper content = null)
        {
        ...
        /// <param name="content">The comment content (optional)</param>
        /// <returns>Task of ApiResponse</returns>
        public async System.Threading.Tasks.Task<ApiResponse<Object>> UpdateCommentAsyncWithHttpInfo (long? id, StringWrapper content = null)
        {
            // verify the required parameter 'id' is set
            if (id == null)
                throw new ApiException(400, "Missing required parameter 'id' when calling ContentCommentsApi->UpdateComment");
