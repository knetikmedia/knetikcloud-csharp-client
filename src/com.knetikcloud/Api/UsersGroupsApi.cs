...
namespace com.knetikcloud.Api
{
    ...
    public interface IUsersGroupsApi : IApiAccessor
    {
        ...
        System.Threading.Tasks.Task<PageResourceGroupResource> UpdateGroupsAsync (string filterTemplate = null, string filterMemberCount = null, string filterName = null, string filterUniqueName = null, string filterParent = null, string filterStatus = null, int? size = null, int? page = null, string order = null);
        ...
        System.Threading.Tasks.Task<ApiResponse<PageResourceGroupResource>> UpdateGroupsAsyncWithHttpInfo (string filterTemplate = null, string filterMemberCount = null, string filterName = null, string filterUniqueName = null, string filterParent = null, string filterStatus = null, int? size = null, int? page = null, string order = null);
    ...
    public partial class UsersGroupsApi : IUsersGroupsApi
    {
        ...
        /// <param name="order">A comma separated list of sorting requirements in priority order, each entry matching PROPERTY_NAME:[ASC|DESC] (optional, default to name:ASC)</param>
        /// <returns>Task of PageResourceGroupResource</returns>
        public async System.Threading.Tasks.Task<PageResourceGroupResource> UpdateGroupsAsync (string filterTemplate = null, string filterMemberCount = null, string filterName = null, string filterUniqueName = null, string filterParent = null, string filterStatus = null, int? size = null, int? page = null, string order = null)
        {
             ApiResponse<PageResourceGroupResource> localVarResponse = await UpdateGroupsAsyncWithHttpInfo(filterTemplate, filterMemberCount, filterName, filterUniqueName, filterParent, filterStatus, size, page, order);
             return localVarResponse.Data;
        ...
        /// <param name="order">A comma separated list of sorting requirements in priority order, each entry matching PROPERTY_NAME:[ASC|DESC] (optional, default to name:ASC)</param>
        /// <returns>Task of ApiResponse (PageResourceGroupResource)</returns>
        public async System.Threading.Tasks.Task<ApiResponse<PageResourceGroupResource>> UpdateGroupsAsyncWithHttpInfo (string filterTemplate = null, string filterMemberCount = null, string filterName = null, string filterUniqueName = null, string filterParent = null, string filterStatus = null, int? size = null, int? page = null, string order = null)
        {
