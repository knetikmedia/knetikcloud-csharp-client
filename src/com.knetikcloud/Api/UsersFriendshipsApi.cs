...
namespace com.knetikcloud.Api
{
    ...
    public interface IUsersFriendshipsApi : IApiAccessor
    {
        ...
        System.Threading.Tasks.Task<PageResourceSimpleUserResource> GetFriendsAsync (string userId, int? size = null, int? page = null);
        ...
        System.Threading.Tasks.Task<ApiResponse<PageResourceSimpleUserResource>> GetFriendsAsyncWithHttpInfo (string userId, int? size = null, int? page = null);
        /// <summary>
        /// Returns the invite token
        /// </summary>
        /// <remarks>
    ...
    public partial class UsersFriendshipsApi : IUsersFriendshipsApi
    {
        ...
        /// <param name="page">The number of the page returned, starting with 1 (optional, default to 1)</param>
        /// <returns>Task of PageResourceSimpleUserResource</returns>
        public async System.Threading.Tasks.Task<PageResourceSimpleUserResource> GetFriendsAsync (string userId, int? size = null, int? page = null)
        {
             ApiResponse<PageResourceSimpleUserResource> localVarResponse = await GetFriendsAsyncWithHttpInfo(userId, size, page);
             return localVarResponse.Data;
        ...
        /// <param name="page">The number of the page returned, starting with 1 (optional, default to 1)</param>
        /// <returns>Task of ApiResponse (PageResourceSimpleUserResource)</returns>
        public async System.Threading.Tasks.Task<ApiResponse<PageResourceSimpleUserResource>> GetFriendsAsyncWithHttpInfo (string userId, int? size = null, int? page = null)
        {
            // verify the required parameter 'userId' is set
            if (userId == null)
                throw new ApiException(400, "Missing required parameter 'userId' when calling UsersFriendshipsApi->GetFriends");
