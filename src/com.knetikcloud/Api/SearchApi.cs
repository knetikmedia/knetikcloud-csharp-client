...
namespace com.knetikcloud.Api
{
    ...
    public interface ISearchApi : IApiAccessor
    {
        ...
        /// <param name="page">The number of the page returned, starting with 1 (optional, default to 1)</param>
        /// <returns>Task of PageResourceMapstringobject</returns>
        System.Threading.Tasks.Task<PageResourceMapstringobject> SearchIndexWithTemplateAsync (string type, string template, Object query = null, int? size = null, int? page = null);
        ...
        /// <param name="page">The number of the page returned, starting with 1 (optional, default to 1)</param>
        /// <returns>Task of ApiResponse (PageResourceMapstringobject)</returns>
        System.Threading.Tasks.Task<ApiResponse<PageResourceMapstringobject>> SearchIndexWithTemplateAsyncWithHttpInfo (string type, string template, Object query = null, int? size = null, int? page = null);
    ...
    public partial class SearchApi : ISearchApi
    {
        ...
        /// <param name="page">The number of the page returned, starting with 1 (optional, default to 1)</param>
        /// <returns>Task of PageResourceMapstringobject</returns>
        public async System.Threading.Tasks.Task<PageResourceMapstringobject> SearchIndexWithTemplateAsync (string type, string template, Object query = null, int? size = null, int? page = null)
        {
             ApiResponse<PageResourceMapstringobject> localVarResponse = await SearchIndexWithTemplateAsyncWithHttpInfo(type, template, query, size, page);
             return localVarResponse.Data;
        ...
        /// <param name="page">The number of the page returned, starting with 1 (optional, default to 1)</param>
        /// <returns>Task of ApiResponse (PageResourceMapstringobject)</returns>
        public async System.Threading.Tasks.Task<ApiResponse<PageResourceMapstringobject>> SearchIndexWithTemplateAsyncWithHttpInfo (string type, string template, Object query = null, int? size = null, int? page = null)
        {
            // verify the required parameter 'type' is set
            if (type == null)
                throw new ApiException(400, "Missing required parameter 'type' when calling SearchApi->SearchIndexWithTemplate");
