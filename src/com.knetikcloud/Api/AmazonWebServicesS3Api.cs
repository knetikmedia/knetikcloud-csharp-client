...
namespace com.knetikcloud.Api
{
    ...
    public interface IAmazonWebServicesS3Api : IApiAccessor
    {
        ...
        System.Threading.Tasks.Task<string> GetDownloadURLAsync (string bucket = null, string path = null, int? expiration = null);
        ...
        System.Threading.Tasks.Task<ApiResponse<string>> GetDownloadURLAsyncWithHttpInfo (string bucket = null, string path = null, int? expiration = null);
        /// <summary>
        /// Get a signed S3 URL for upload
        /// </summary>
        /// <remarks>
    ...
    public partial class AmazonWebServicesS3Api : IAmazonWebServicesS3Api
    {
        ...
        /// <param name="expiration">The number of seconds this URL will be valid. Default to 60 (optional, default to 60)</param>
        /// <returns>Task of string</returns>
        public async System.Threading.Tasks.Task<string> GetDownloadURLAsync (string bucket = null, string path = null, int? expiration = null)
        {
             ApiResponse<string> localVarResponse = await GetDownloadURLAsyncWithHttpInfo(bucket, path, expiration);
             return localVarResponse.Data;
        ...
        /// <param name="expiration">The number of seconds this URL will be valid. Default to 60 (optional, default to 60)</param>
        /// <returns>Task of ApiResponse (string)</returns>
        public async System.Threading.Tasks.Task<ApiResponse<string>> GetDownloadURLAsyncWithHttpInfo (string bucket = null, string path = null, int? expiration = null)
        {
