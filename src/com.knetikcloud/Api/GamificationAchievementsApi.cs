...
namespace com.knetikcloud.Api
{
    ...
    public interface IGamificationAchievementsApi : IApiAccessor
    {
        ...
        /// <param name="progress">The amount to add to the progress value (optional)</param>
        /// <returns>Task of UserAchievementGroupResource</returns>
        System.Threading.Tasks.Task<UserAchievementGroupResource> IncrementAchievementProgressAsync (int? userId, string achievementName, int? progress = null);
        ...
        /// <param name="progress">The amount to add to the progress value (optional)</param>
        /// <returns>Task of ApiResponse (UserAchievementGroupResource)</returns>
        System.Threading.Tasks.Task<ApiResponse<UserAchievementGroupResource>> IncrementAchievementProgressAsyncWithHttpInfo (int? userId, string achievementName, int? progress = null);
        /// <summary>
        /// Set an achievement progress record for a user
        /// </summary>
        /// <remarks>
        ...
        /// <param name="progress">The new progress value (optional)</param>
        /// <returns>Task of UserAchievementGroupResource</returns>
        System.Threading.Tasks.Task<UserAchievementGroupResource> SetAchievementProgressAsync (int? userId, string achievementName, int? progress = null);
        ...
        /// <param name="progress">The new progress value (optional)</param>
        /// <returns>Task of ApiResponse (UserAchievementGroupResource)</returns>
        System.Threading.Tasks.Task<ApiResponse<UserAchievementGroupResource>> SetAchievementProgressAsyncWithHttpInfo (int? userId, string achievementName, int? progress = null);
        /// <summary>
        /// Update an achievement definition
        /// </summary>
        /// <remarks>
    ...
    public partial class GamificationAchievementsApi : IGamificationAchievementsApi
    {
        ...
        /// <param name="progress">The amount to add to the progress value (optional)</param>
        /// <returns>Task of UserAchievementGroupResource</returns>
        public async System.Threading.Tasks.Task<UserAchievementGroupResource> IncrementAchievementProgressAsync (int? userId, string achievementName, int? progress = null)
        {
        ...
        /// <param name="progress">The amount to add to the progress value (optional)</param>
        /// <returns>Task of ApiResponse (UserAchievementGroupResource)</returns>
        public async System.Threading.Tasks.Task<ApiResponse<UserAchievementGroupResource>> IncrementAchievementProgressAsyncWithHttpInfo (int? userId, string achievementName, int? progress = null)
        {
            // verify the required parameter 'userId' is set
            if (userId == null)
                throw new ApiException(400, "Missing required parameter 'userId' when calling GamificationAchievementsApi->IncrementAchievementProgress");
        ...
        /// <param name="progress">The new progress value (optional)</param>
        /// <returns>Task of UserAchievementGroupResource</returns>
        public async System.Threading.Tasks.Task<UserAchievementGroupResource> SetAchievementProgressAsync (int? userId, string achievementName, int? progress = null)
        {
        ...
        /// <param name="progress">The new progress value (optional)</param>
        /// <returns>Task of ApiResponse (UserAchievementGroupResource)</returns>
        public async System.Threading.Tasks.Task<ApiResponse<UserAchievementGroupResource>> SetAchievementProgressAsyncWithHttpInfo (int? userId, string achievementName, int? progress = null)
        {
            // verify the required parameter 'userId' is set
            if (userId == null)
                throw new ApiException(400, "Missing required parameter 'userId' when calling GamificationAchievementsApi->SetAchievementProgress");
