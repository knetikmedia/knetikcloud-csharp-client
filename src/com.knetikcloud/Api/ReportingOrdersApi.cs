...
namespace com.knetikcloud.Api
{
    ...
    public interface IReportingOrdersApi : IApiAccessor
    {
        ...
        System.Threading.Tasks.Task<PageResourceAggregateInvoiceReportResource> GetInvoiceReportsAsync (string currencyCode, string granularity = null, string filterPaymentStatus = null, string filterFulfillmentStatus = null, long? startDate = null, long? endDate = null, int? size = null, int? page = null);
        ...
        System.Threading.Tasks.Task<ApiResponse<PageResourceAggregateInvoiceReportResource>> GetInvoiceReportsAsyncWithHttpInfo (string currencyCode, string granularity = null, string filterPaymentStatus = null, string filterFulfillmentStatus = null, long? startDate = null, long? endDate = null, int? size = null, int? page = null);
    ...
    public partial class ReportingOrdersApi : IReportingOrdersApi
    {
        ...
        /// <param name="page">The number of the page returned (optional, default to 1)</param>
        /// <returns>Task of PageResourceAggregateInvoiceReportResource</returns>
        public async System.Threading.Tasks.Task<PageResourceAggregateInvoiceReportResource> GetInvoiceReportsAsync (string currencyCode, string granularity = null, string filterPaymentStatus = null, string filterFulfillmentStatus = null, long? startDate = null, long? endDate = null, int? size = null, int? page = null)
        {
             ApiResponse<PageResourceAggregateInvoiceReportResource> localVarResponse = await GetInvoiceReportsAsyncWithHttpInfo(currencyCode, granularity, filterPaymentStatus, filterFulfillmentStatus, startDate, endDate, size, page);
             return localVarResponse.Data;
        ...
        /// <param name="page">The number of the page returned (optional, default to 1)</param>
        /// <returns>Task of ApiResponse (PageResourceAggregateInvoiceReportResource)</returns>
        public async System.Threading.Tasks.Task<ApiResponse<PageResourceAggregateInvoiceReportResource>> GetInvoiceReportsAsyncWithHttpInfo (string currencyCode, string granularity = null, string filterPaymentStatus = null, string filterFulfillmentStatus = null, long? startDate = null, long? endDate = null, int? size = null, int? page = null)
        {
            // verify the required parameter 'currencyCode' is set
            if (currencyCode == null)
                throw new ApiException(400, "Missing required parameter 'currencyCode' when calling ReportingOrdersApi->GetInvoiceReports");
