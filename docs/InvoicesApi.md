...
# **GetInvoices**
> PageResourceInvoiceResource GetInvoices (int? filterUser = null, string filterEmail = null, string filterFulfillmentStatus = null, string filterPaymentStatus = null, string filterItemName = null, string filterCreatedDate = null, int? size = null, int? page = null, string order = null)
...
namespace Example
{
    public class ListFulFillmentStatusesExample
    {
        public void main()
        {
            ...
            {
                Debug.Print("Exception when calling InvoicesApi.ListFulFillmentStatuses: " + e.Message );
            }
        }
    }
}
...
namespace Example
{
    public class ListPaymentStatusesExample
    {
        public void main()
        {
            ...
            {
                Debug.Print("Exception when calling InvoicesApi.ListPaymentStatuses: " + e.Message );
            }
        }
    }
}
