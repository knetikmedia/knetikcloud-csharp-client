...
> void DeleteGroupUsingDELETE (string uniqueName, int? userId)
...
> void DeleteGroupUsingDELETE1 (string uniqueName)
...
namespace Example
{
    public class DeleteGroupUsingDELETE1Example
    {
        public void main()
        {
            ...
            {
                Debug.Print("Exception when calling UsersGroupsApi.DeleteGroupUsingDELETE1: " + e.Message );
            }
        }
    }
}
...
> PageTemplateResource GetGroupTemplatesUsingGET (int? size = null, int? page = null, string order = null)
...
> PageGroupMemberResource SearchGroupsUsingGET (string uniqueName, int? size = null, int? page = null, string order = null)
...
> PageGroupResource SearchGroupsUsingGET1 (int? size = null, int? page = null, string order = null)
