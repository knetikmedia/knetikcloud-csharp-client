...
> void DeleteRelationshipUsingDELETE (long? videoId, long? id)
...
namespace Example
{
    public class DeleteRelationshipUsingDELETEExample
    {
        public void main()
        {
            ...
            {
                // Delete a video's relationship
                apiInstance.DeleteRelationshipUsingDELETE(videoId, id);
            }
            catch (Exception e)
            {
                Debug.Print("Exception when calling MediaVideosApi.DeleteRelationshipUsingDELETE: " + e.Message );
            }
        }
    }
}
...
> PageCommentResource GetCommentsUsingGET1 (int? videoId, int? size = null, int? page = null)
...
> PageDispositionResource GetDispositionsUsingGET1 (int? videoId, int? size = null, int? page = null)
...
# **GetRelatedUsingGET**
> PageVideoRelationshipResource GetRelatedUsingGET (long? videoId, int? size = null, int? page = null)
...
> PageVideoResource GetUserVideosUsingGET (int? userId, bool? excludeFlagged = null, int? size = null, int? page = null)
...
> void UpdateRelationshipUsingPUT (long? videoId, long? relationshipId, string details = null)
...
namespace Example
{
    public class UpdateRelationshipUsingPUTExample
    {
        public void main()
        {
            ...
            {
                // Update a video's relationship details
                apiInstance.UpdateRelationshipUsingPUT(videoId, relationshipId, details);
            }
            catch (Exception e)
            {
                Debug.Print("Exception when calling MediaVideosApi.UpdateRelationshipUsingPUT: " + e.Message );
            }
        }
    }
}
