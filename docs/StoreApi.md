...
# **CreateStoreItem**
> StoreItem CreateStoreItem (StoreItem storeItem = null)
...
# **UpdateItemTemplate**
> void UpdateItemTemplate (string id, StoreItemTemplateResource itemTemplateResource = null)
...
# **UpdateStoreItem**
> void UpdateStoreItem (int? id, StoreItem storeItem = null)
