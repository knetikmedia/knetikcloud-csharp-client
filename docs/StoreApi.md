...
> ItemTemplateResource CreateItemTemplateUsingPOST (ItemTemplateResource itemTemplateResource = null)
...
namespace Example
{
    public class CreateItemTemplateUsingPOSTExample
    {
        public void main()
        {
            ...
            var itemTemplateResource = new ItemTemplateResource(); // ItemTemplateResource | The new item template (optional) 

            try
            {
                // Create an item template
                ItemTemplateResource result = apiInstance.CreateItemTemplateUsingPOST(itemTemplateResource);
...
> ItemTemplateResource GetItemTemplateUsingGET (string id)
...
namespace Example
{
    public class GetItemTemplateUsingGETExample
    {
        public void main()
        {
            ...
            {
                // Get a single item template
                ItemTemplateResource result = apiInstance.GetItemTemplateUsingGET(id);
                Debug.WriteLine(result);
            }
            catch (Exception e)
            {
...
> PageItemTemplateResource GetItemTemplatesUsingGET (int? size = null, int? page = null, string order = null)
...
namespace Example
{
    public class GetItemTemplatesUsingGETExample
    {
        public void main()
        {
            ...
            {
                // List and search item templates
                PageItemTemplateResource result = apiInstance.GetItemTemplatesUsingGET(size, page, order);
                Debug.WriteLine(result);
            }
            catch (Exception e)
            {
...
> void UpdateItemTemplateUsingPUT (string id, ItemTemplateResource itemTemplateResource = null)
...
namespace Example
{
    public class UpdateItemTemplateUsingPUTExample
    {
        public void main()
        {
            ...
            var apiInstance = new StoreApi();
            var id = id_example;  // string | The id of the template
            var itemTemplateResource = new ItemTemplateResource(); // ItemTemplateResource | The item template resource object (optional) 
