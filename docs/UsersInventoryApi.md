...
> PageUserInventoryResource GetInventoryListUsingGET (bool? inactive = null, int? size = null, int? page = null, string filterItemName = null, long? filterMinDate = null, long? filterMaxDate = null)
...
namespace Example
{
    public class GetInventoryListUsingGETExample
    {
        public void main()
        {
            ...
            {
                // List the user inventory entries for all users
                PageUserInventoryResource result = apiInstance.GetInventoryListUsingGET(inactive, size, page, filterItemName, filterMinDate, filterMaxDate);
                Debug.WriteLine(result);
            }
            catch (Exception e)
            {
