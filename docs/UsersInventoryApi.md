...
> EntitlementItem CreateEntitlementItem (EntitlementItem entitlementItem = null)
...
# **GetUserInventory1**
> PageResourceUserInventoryResource GetUserInventory1 (int? id, bool? inactive = null, int? size = null, int? page = null, string filterItemName = null, long? filterMinDate = null, long? filterMaxDate = null)
...
namespace Example
{
    public class GetUserInventory1Example
    {
        public void main()
        {
            ...
            {
                Debug.Print("Exception when calling UsersInventoryApi.GetUserInventory1: " + e.Message );
            }
        }
    }
}
...
> void GetUserInventoryLog1 (int? userId, int? id, long? timestamp = null)
...
namespace Example
{
    public class GetUserInventoryLog1Example
    {
        public void main()
        {
            ...
            {
                Debug.Print("Exception when calling UsersInventoryApi.GetUserInventoryLog1: " + e.Message );
            }
        }
    }
}
...
# **GetUsersInventory**
> PageResourceUserInventoryResource GetUsersInventory (bool? inactive = null, int? size = null, int? page = null, string filterItemName = null, string filterUsername = null, string filterGroup = null, string filterDate = null)
...
> void UpdateEntitlementItem (int? entitlementId, EntitlementItem entitlementItem = null)
...
> void UpdateEntitlementTemplate (string id, ItemTemplateResource template = null)
