...
# **GetActivities**
> PageResourceBareActivityResource GetActivities (bool? filterTemplate = null, int? size = null, int? page = null, string order = null)
...
# **UpdateActivity**
> void UpdateActivity (long? id, ActivityResource activityResource = null)
