...
# **UserUsingGET**
> TokenDetailsResource UserUsingGET (Authentication authentication = null)
...
namespace Example
{
    public class UserUsingGETExample
    {
        public void main()
        {
            ...
            var apiInstance = new UtilSecurityApi();
            var authentication = new Authentication(); // Authentication | The Authentication Object (optional) 
