...
# **CreateCouponItem**
> CouponItem CreateCouponItem (CouponItem couponItem = null)
...
# **UpdateCouponItem**
> void UpdateCouponItem (int? id, CouponItem couponItem = null)
...
> void UpdateCouponTemplate (string id, ItemTemplateResource couponTemplateResource = null)
