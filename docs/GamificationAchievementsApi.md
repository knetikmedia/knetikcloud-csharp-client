...
> PageAchievementDefinitionResource GetAchievementsUsingGET (string filterTagset = null, string filterName = null, bool? filterHidden = null, int? size = null, int? page = null, string order = null)
...
namespace Example
{
    public class GetAchievementsUsingGETExample
    {
        public void main()
        {
            ...
            {
                // Get all achievement definitions in the system
                PageAchievementDefinitionResource result = apiInstance.GetAchievementsUsingGET(filterTagset, filterName, filterHidden, size, page, order);
                Debug.WriteLine(result);
            }
            catch (Exception e)
            {
...
> PageUserAchievementResource GetAllUserProgressForAchievementUsingGET (string achievementName, string filterAchievementTagset = null, bool? filterAchievementHidden = null, int? size = null, int? page = null)
...
namespace Example
{
    public class GetAllUserProgressForAchievementUsingGETExample
    {
        public void main()
        {
            ...
            {
                // Retrieve progress on a given achievement for all users
                PageUserAchievementResource result = apiInstance.GetAllUserProgressForAchievementUsingGET(achievementName, filterAchievementTagset, filterAchievementHidden, size, page);
                Debug.WriteLine(result);
            }
            catch (Exception e)
            {
...
> PageUserAchievementResource GetAllUserProgressUsingGET (string filterAchievementTagset = null, string filterAchievementName = null, bool? filterAchievementHidden = null, int? size = null, int? page = null)
...
namespace Example
{
    public class GetAllUserProgressUsingGETExample
    {
        public void main()
        {
            ...
            {
                // Retrieve progress on achievements for all users
                PageUserAchievementResource result = apiInstance.GetAllUserProgressUsingGET(filterAchievementTagset, filterAchievementName, filterAchievementHidden, size, page);
                Debug.WriteLine(result);
            }
            catch (Exception e)
            {
...
> UserAchievementResource GetUserProgressForAchievementUsingGET (int? userId, string achievementName)
...
namespace Example
{
    public class GetUserProgressForAchievementUsingGETExample
    {
        public void main()
        {
            ...
            {
                // Retrieve progress on a given achievement for a given user
                UserAchievementResource result = apiInstance.GetUserProgressForAchievementUsingGET(userId, achievementName);
                Debug.WriteLine(result);
            }
            catch (Exception e)
            {
...
> PageUserAchievementResource GetUserProgressUsingGET (int? userId, string filterAchievementTagset = null, string filterAchievementName = null, bool? filterAchievementHidden = null, int? size = null, int? page = null)
...
namespace Example
{
    public class GetUserProgressUsingGETExample
    {
        public void main()
        {
            ...
            {
                // Retrieve progress on achievements for a given user
                PageUserAchievementResource result = apiInstance.GetUserProgressUsingGET(userId, filterAchievementTagset, filterAchievementName, filterAchievementHidden, size, page);
                Debug.WriteLine(result);
            }
            catch (Exception e)
            {
...
> UserAchievementResource UpdateProgressUsingPUT (int? userId, string achievementName, AchievementProgressUpdateRequest request = null)
...
namespace Example
{
    public class UpdateProgressUsingPUTExample
    {
        public void main()
        {
            ...
            {
                // Update or create an achievement progress record for a user
                UserAchievementResource result = apiInstance.UpdateProgressUsingPUT(userId, achievementName, request);
                Debug.WriteLine(result);
            }
            catch (Exception e)
            {
