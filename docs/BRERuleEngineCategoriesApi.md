...
> PageResourceBreCategoryResource GetCategoriesUsingGET (int? size = null, int? page = null)
...
> PageResourceTemplateResource GetTemplatesUsingGET (int? size = null, int? page = null, string order = null)
