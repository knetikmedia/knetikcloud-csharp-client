...
> PageTemplateResource GetCampaignTemplatesUsingGET (int? size = null, int? page = null, string order = null)
...
> PageCampaignResource GetCampaignsUsingGET (bool? filterActive = null, int? size = null, int? page = null, string order = null)
...
> PageChallengeResource GetChallengesUsingGET (long? id)
