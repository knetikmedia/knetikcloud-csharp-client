...
# **CreateShippingItem**
> ShippingItem CreateShippingItem (ShippingItem shippingItem = null)
...
# **UpdateShippingItem**
> void UpdateShippingItem (int? id, ShippingItem shippingItem = null)
...
> void UpdateShippingTemplate (string id, ItemTemplateResource shippingTemplateResource = null)
