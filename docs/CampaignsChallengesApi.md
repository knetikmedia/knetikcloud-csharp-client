...
> PageBareChallengeActivityResource GetActivitiesUsingGET1 (long? challengeId, int? size = null, int? page = null, string order = null)
...
> PageChallengeEventResource GetChallengeEventssUsingGET (long? filterStartDateMin = null, long? filterStartDateMax = null, long? filterEndDateMin = null, long? filterEndDateMax = null, bool? filterCampaigns = null, long? filterChallenge = null, int? size = null, int? page = null, string order = null)
...
namespace Example
{
    public class GetChallengeEventssUsingGETExample
    {
        public void main()
        {
            ...
            var apiInstance = new CampaignsChallengesApi();
            var filterStartDateMin = 789;  // long? | events starting after this date, unix timestamp in seconds (optional) 
            var filterStartDateMax = 789;  // long? | events starting before this date, unix timestamp in seconds (optional) 
            var filterEndDateMin = 789;  // long? | events ending after this date, unix timestamp in seconds (optional) 
            var filterEndDateMax = 789;  // long? | events ending before this date, unix timestamp in seconds (optional) 
            ...
            {
                // Retrieve a list of challenge events
                PageChallengeEventResource result = apiInstance.GetChallengeEventssUsingGET(filterStartDateMin, filterStartDateMax, filterEndDateMin, filterEndDateMax, filterCampaigns, filterChallenge, size, page, order);
                Debug.WriteLine(result);
            }
            catch (Exception e)
            {
...
Name | Type | Description  | Notes
------------- | ------------- | ------------- | -------------
 **filterStartDateMin** | **long?**| events starting after this date, unix timestamp in seconds | [optional] 
 **filterStartDateMax** | **long?**| events starting before this date, unix timestamp in seconds | [optional] 
 **filterEndDateMin** | **long?**| events ending after this date, unix timestamp in seconds | [optional] 
 **filterEndDateMax** | **long?**| events ending before this date, unix timestamp in seconds | [optional] 
...
> PageTemplateResource GetChallengeTemplatesUsingGET (int? size = null, int? page = null, string order = null)
...
> PageChallengeResource GetChallengesUsingGET1 (bool? filterTemplate = null, bool? filterActiveCampaign = null)
