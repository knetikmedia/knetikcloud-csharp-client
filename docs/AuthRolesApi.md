...
# **SetClientRoles**
> void SetClientRoles (string clientKey, List<string> rolesList = null)
...
> void SetPermissionsForRole (string role, List<string> permissionsList = null)
...
# **SetUserRoles**
> void SetUserRoles (int? userId, List<string> rolesList = null)
...
<a name="updaterole"></a>
# **UpdateRole**
> void UpdateRole (string role, RoleResource roleResource = null)
